define(['jquery',
        ...
        'session',
        'text!/form-cotizaciones-individuales/js/libs/framework/templates/app/reporte/reporteVtaPura.html',
        'text!/form-cotizaciones-individuales/js/libs/framework/templates/app/reporte/tablaVtaPuraReporte.html',
    ...
    function ($, _, Backbone, datatablesBT, Handlebars, bootstrap, ace, Encoding, SettingsModel, Util, LoginService,
              ...
              searchTemplate, ListSearchView, ProspectoService, CotizacionesService ) {
        ...
        var contacto = null, cotizacion = null, obrasSociales = [], resultArray = null,
            ...
            reporteCotizacionView = Backbone.View.extend({
                ...
                buscar: function () {
                    ...
                    var url = SettingsModel.get("cotizaciones_prospecto_rest_api_url") + 'reporte-venta-individuos?';
...
//                                fechaFin: moment(resultArray[i].fecha_fin_vigencia).format("DD/MM/YYYY"),
                                ...
                                usuario: resultArray[i].vp_usuario,
                                ...
                                tipo: resultArray[i].tipo_docu == "1 " ? 'DU' : resultArray[i].tipo_docu,
                                numero: resultArray[i].nro_docu,
                                apellido: resultArray[i].apellido,
                                producto: resultArray[i].Producto_Vendido,
...
//                        {fechaFin: "Fecha Fin"},
                    ...
                    this.JSONToCSVConvertor(cotizacionesCSV, "Cotizaciones-Vta-Individuos-" + dateString, columnConf, function (row, index) {
                        if (row[index] == null) {
                            return "";
                        }
                        if (index === 'nroDoc') {
